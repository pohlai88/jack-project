...
This document describes how Afenda uses [shadcn/ui](https://ui.shadcn.com) — a collection of reusable, accessible components built on [Radix UI](https://www.radix-ui.com/) primitives and styled with [Tailwind CSS](https://tailwindcss.com/).

---

## How We Use shadcn/ui

Afenda follows the **copy/paste** model of shadcn/ui. Components are **not** installed as a dependency; they live directly in the codebase under `src/shared/components/ui/`. This gives us full control to customize, extend, and compose components to fit our domain.

### Key Differences from a Standard shadcn Setup

| Aspect        | Standard shadcn                | Afenda                                                 |
| ------------- | ------------------------------ | ------------------------------------------------------ |
...
Built on top of shadcn primitives for Afenda-specific UI patterns:
...
Afenda extends the standard shadcn Button with domain-specific variants using `class-variance-authority` (CVA):
