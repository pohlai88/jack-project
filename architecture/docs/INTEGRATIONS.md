...
Third-party API integrations using OAuth2 or other auth. The Afenda uses Auth.js for **sign-in** (Auth0, development credentials). Integrations below are for **API access** (e.g., syncing data, calling external APIs on behalf of the user or tenant).
