...
Afenda is a standard Next.js application with a PostgreSQL + pgvector database. It can be deployed to any platform that supports Node.js and PostgreSQL.
...
```bash
docker build -t afenda .
docker run -p 3000:3000 --env-file .env afenda
```
