...
Afenda uses a combination of React Server Components, React Context, and local state. There is no need for a single centralized store.
...
Afenda uses React Context for tenant information:
