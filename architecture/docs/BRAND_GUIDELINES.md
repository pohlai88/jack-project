# Afenda — Brand Guidelines

> This document defines the visual identity defaults of the Afenda. Tenants can customize brand colors and logos via admin settings. For design tokens, principles, and component patterns, see [DESIGN_SYSTEM.md](./DESIGN_SYSTEM.md).
