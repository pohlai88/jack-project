...
Afenda is optimized for performance using Next.js 15, React Server Components, and Tailwind CSS v4.
...
- If your application is expected to have frequent updates that might affect performance, use zero-runtime styling solutions. **Afenda uses Tailwind CSS v4** which generates styles at build time with no runtime overhead.
