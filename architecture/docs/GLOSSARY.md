# Glossary of Terms - Afenda

This document defines key terms used in Afenda to avoid ambiguities and facilitate understanding of the domain. Each term includes its definition, references to standards when applicable, and its relationship with other concepts.
