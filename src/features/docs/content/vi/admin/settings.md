...
title: Cài đặt
description: >-
  Feature flags, branding (logo, màu sắc), cấu hình AI provider, thang kỹ năng,
...
**Feature flags** bật hoặc tắt tính năng cho tenant mà không cần deploy code.
...
## Từng bước: đổi branding và một feature flag

1. Vào **Admin** → **Settings**.
2. **Branding** — Upload logo mới và đặt màu primary. Lưu.
3. **Feature flags** — Tìm flag, ví dụ "Recognitions", rồi bật hoặc tắt. Lưu.
