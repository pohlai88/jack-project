...
/* ------------------------------------------------------------------------
   ...
   export type DocsPageFeedbackActionResult =
     | DocsPageFeedbackSuccess
     | DocsPageFeedbackFailure;
   ...
   export function failDocsFeedback(
     code: DocsFeedbackErrorCode,
     message: string,
   ): DocsPageFeedbackFailure {
   ...
   export function isDocsFeedbackSuccess(
     result: DocsPageFeedbackActionResult,
   ): result is DocsPageFeedbackSuccess {
     return result.ok === true;
   }

   export function isDocsFeedbackFailure(
     result: DocsPageFeedbackActionResult,
   ): result is DocsPageFeedbackFailure {
