...
export default defineDocsManifest({
  ...
  actions: [
    {
      ...
      summary:
        'Run the documentation generation pipeline from manifest-backed product truth.',
    },
    {
  ...
  apis: [
    ...
    },
    {
      ...
      route: '/rss.xml',
      summary:
        'Expose an RSS feed for generated documentation evidence pages.',
    },
    {
      id: 'docs.og.image',
      ...
      summary:
        'Generate Open Graph images for documentation pages using next/og and the Fumadocs UI template.',
    },
  ],
  ...
  errors: [
    ...
    },
    {
      ...
      mitigation:
        'Check database connectivity and the docs_page_feedback_events migration state.',
    },
  ],
  ...
  troubleshooting: [
    ...
    },
    {
      ...
      symptom:
        'A documentation page feedback form shows a submission failure.',
      resolution:
