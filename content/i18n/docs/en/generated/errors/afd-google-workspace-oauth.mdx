...
description: 'Error evidence for AFD-GOOGLE-WORKSPACE-OAUTH.'
...
/>
<Banner id="error-afd-google-workspace-oauth" changeLayout={false}>
  GENERATED EVIDENCE - This page is rendered from validated product truth.
</Banner>

## Overview: what this error means

This page records the generated evidence for `AFD-GOOGLE-WORKSPACE-OAUTH`.
...
<TypeTable
  type={{
    Code: {
      type: 'AFD-GOOGLE-WORKSPACE-OAUTH',
...
Validate OAuth state, Google credentials, callback URL, and tenant context.
