...
Use this page to confirm which feature manifests claim `admin:integrations` and where permission coverage must remain
aligned.
...
<TypeTable
  type={{
    ...
    Coverage: {
      type: 'google-workspace, integration-sync, linkedin',
