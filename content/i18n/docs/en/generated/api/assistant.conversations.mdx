...
<Callout title="Truth Surface: assistant.conversations" type="info">
  - API ID: `assistant.conversations` - Route: `GET /api/assistant/conversations` - Owning feature: `assistant` -
...
<Steps>
  ...
  <Step>Confirm the Next.js route `/api/assistant/conversations` exists.</Step>
