---
title: 'Docs Search'
description: 'Search index endpoint backed by the Fumadocs source registry.'
...
<Callout title="Truth Surface: docs.search" type="info">
  - API ID: `docs.search` - Route: `GET /api/search` - Owning feature: `docs` - OpenAPI reference: `/docs/openapi`
</Callout>

## Overview: what this API actually does

Search index endpoint backed by the Fumadocs source registry.
...
<Steps>
  ...
  <Step>Confirm the Next.js route `/api/search` exists.</Step>
