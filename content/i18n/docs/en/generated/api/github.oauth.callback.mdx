...
<Callout title="Truth Surface: github.oauth.callback" type="info">
  - API ID: `github.oauth.callback` - Route: `GET /api/integrations/github/callback` - Owning feature: `github` -
...
<Steps>
  ...
  <Step>Confirm the Next.js route `/api/integrations/github/callback` exists.</Step>
