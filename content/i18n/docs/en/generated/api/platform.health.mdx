...
<Callout title="Truth Surface: platform.health" type="info">
  - API ID: `platform.health` - Route: `GET /api/health` - Owning feature: `dashboard` - OpenAPI reference:
  `/docs/openapi`
</Callout>
...
<Steps>
  ...
  <Step>Confirm the Next.js route `/api/health` exists.</Step>
