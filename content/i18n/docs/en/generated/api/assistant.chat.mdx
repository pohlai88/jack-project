...
<Callout title="Truth Surface: assistant.chat" type="info">
  - API ID: `assistant.chat` - Route: `POST /api/chat` - Owning feature: `assistant` - OpenAPI reference:
  `/docs/openapi`
</Callout>
...
<Steps>
  ...
  <Step>Confirm the Next.js route `/api/chat` exists.</Step>
