---
title: 'Docs Rss'
description: 'RSS feed for documentation pages.'
...
/>
<Banner id="api-docs.rss" changeLayout={false}>
  GENERATED EVIDENCE - This page is rendered from validated product truth.
</Banner>

<Callout title="Truth Surface: docs.rss" type="info">
  - API ID: `docs.rss` - Route: `GET /rss.xml` - Owning feature: `docs` - OpenAPI reference: `/docs/openapi`
</Callout>

## Overview: what this API actually does

RSS feed for documentation pages.
...
<Steps>
  ...
  <Step>Confirm the Next.js route `/rss.xml` exists.</Step>
