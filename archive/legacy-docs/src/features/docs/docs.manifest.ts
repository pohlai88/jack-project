...
export default defineDocsManifest({
  ...
  routes: ['/docs', '/docs/[[...slug]]', '/api/docs/search-index'],
  permissions: [],
  workflows: [
    {
  ...
  apis: [
    {
      id: 'docs.legacy-search-index',
      method: 'GET',
      route: '/api/docs/search-index',
      summary: 'Legacy docs search index endpoint retained during renderer migration.',
    },
  ],
  errors: [
    {
